...
# Copyright 2016, 2017, 2025 Juca Crispim <juca@poraodojuca.net>
...
from mongomotor import monkey, Document, context_managers
...
class MonkeyPatcherTest(TestCase):
    ...
    def test_patch_dereference(self):
        ...
        self.assertIs(DeReference, MongoMotorDeReference)
